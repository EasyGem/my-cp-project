...
<div class="site-index">
        <h1>Редактировать событие</h1><br>
    ...
    <div class="col-md-9 col-sm-8">
      <div class="site-news-panel-add">
          ...
          ?>
            ...
            ->input('text', ['readonly' => (Yii::$app->user->identity->accessToken == 'organisator')?(true):(false), 'value' => (isset($model->organisator))?$model->organisator:('')]); ?>
